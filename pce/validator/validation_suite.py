...
from pce.gateway.logs_aws import PCELogsGateway
...
class ValidationSuite:
    def __init__(
        ...
        ecs_gateway: Optional[PCEECSGateway] = None,
        logs_gateway: Optional[PCELogsGateway] = None,
    ) -> None:
        ...
        self.ecs_gateway: PCEECSGateway = ecs_gateway or PCEECSGateway(
            region, key_id, key_data, config
        )

        self.logs_gateway: PCELogsGateway = logs_gateway or PCELogsGateway(
            region, key_id, key_data, config
        )
